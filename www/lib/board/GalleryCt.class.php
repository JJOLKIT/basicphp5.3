	...
	function insert($req="") {
		...
		$sql = "
			INSERT INTO ".$this->tableName." (
				category, name, title, contents, relation_url, registdate, ";
		if ($req[filename]) {
	...
	function update($req="") {
		...
		$sql = "
			UPDATE ".$this->tableName." SET 
				category = ".chkIsset($req[category]).", name='$req[name]', title='$req[title]', contents='$req[contents]', relation_url= '$req[relation_url]', ";
		if ($req[filename]) {
