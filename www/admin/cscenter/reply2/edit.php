		...
		<form method="post" name="frm" id="frm" action="<?=getSslCheckUrl($_SERVER['REQUEST_URI'], 'process.php')?>" enctype="multipart/form-data">
			<div class="wr_box">
				...
				<table class="row_line">
					...
					<tr>
						<th>연락처</th>
						<td><input type="tel" id="cell" name="cell" value="<?=escape_html($data['cell'])?>" class="wid200"/></td>
						<th>이메일</th>
						<td><input type="text" name="email" id="email" value="<?=esacpe_html($data['email'])?>" class="wid300"/></td>
					</tr>
					<!--
					<tr>
						<th>노출설정</th>
			...
			<div class="wr_box">
				...
				<table>
					...
					<tr>
						<th>제목</th>
						<td>
							<input type="text" name="title" id="title"  value="<?=escape_html($data['title']) ?>" />
						</td>
					</tr>
					<tr>
						<th>내용</th>
